import { ArrowLeft, Bell, Lock, Globe, HelpCircle, FileText, LogOut, ChevronRight, Ship, DollarSign, Clock, CreditCard } from 'lucide-react';
...
export default function CaptainSettings({ onNavigate }: CaptainSettingsProps) {
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#BDD8E9' }}>
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <button 
            onClick={() => onNavigate('notifications-captain')}
          ...
          <button 
            onClick={() => onNavigate('change-password-captain')}
          ...
          <button 
            onClick={() => onNavigate('language-captain')}
            className="w-full px-6 py-4 flex items-center justify-between hover:bg-[#BDD8E9]/30 transition-colors border-t border-gray-100"
          >
            <div className="flex items-center gap-3">
        ...
        {/* Business Settings - Captain Only */}
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100">
            <h3 className="text-[#001D39]">Business Settings</h3>
          </div>
          
          <button 
            onClick={() => onNavigate('boat-information')}
            className="w-full px-6 py-4 flex items-center justify-between hover:bg-[#BDD8E9]/30 transition-colors"
          >
            <div className="flex items-center gap-3">
              <Ship className="w-5 h-5" style={{ color: '#0A4174' }} />
              <span className="text-[#001D39]">Boat Information</span>
            </div>
            <ChevronRight className="w-5 h-5 text-[#49769F]" />
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              <DollarSign className="w-5 h-5" style={{ color: '#0A4174' }} />
              <span className="text-[#001D39]">Pricing</span>
            </div>
            <ChevronRight className="w-5 h-5 text-[#49769F]" />
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              <Clock className="w-5 h-5" style={{ color: '#0A4174' }} />
              <span className="text-[#001D39]">Availability</span>
            </div>
            <ChevronRight className="w-5 h-5 text-[#49769F]" />
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              <CreditCard className="w-5 h-5" style={{ color: '#0A4174' }} />
              <div className="text-left">
                <div className="text-[#001D39]">Subscription Status</div>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <button 
            onClick={() => onNavigate('help-center-captain')}
            className="w-full px-6 py-4 flex items-center justify-between hover:bg-[#BDD8E9]/30 transition-colors"
          >
            <div className="flex items-center gap-3">
          ...
          <button 
            onClick={() => onNavigate('terms-conditions-captain')}
            className="w-full px-6 py-4 flex items-center justify-between hover:bg-[#BDD8E9]/30 transition-colors border-t border-gray-100"
          >
            <div className="flex items-center gap-3">
          ...
          <button 
            onClick={() => onNavigate('privacy-policy-captain')}
            className="w-full px-6 py-4 flex items-center justify-between hover:bg-[#BDD8E9]/30 transition-colors border-t border-gray-100"
          >
            <div className="flex items-center gap-3">
              <FileText className="w-5 h-5" style={{ color: '#0A4174' }} />
